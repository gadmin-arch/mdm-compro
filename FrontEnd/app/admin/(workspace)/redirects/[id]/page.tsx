...
export default async function EditRedirectPage({
  ...
  if (!data) {
    return (
      <>
      <AdminPageHeader breadcrumbs={[{ label: "Short Links", href: "/admin/redirects" }, { label: "Edit" }]} eyebrow="Marketing" title="Short Link"
      />
  ...
  return (
    <>
      <AdminPageHeader
        breadcrumbs={[{ label: "Short Links", href: "/admin/redirects" }, { label: "Edit" }]}
        eyebrow="Marketing"
        title={redirect.name}
      />
      {query.duplicated && (
