...
const BRAND_ASSETS: Record<string, { src: string; width: number; height: number; alt: string }> = {
  ...
  hitachi: { src: "/brands/hitachi.png", width: 284, height: 47, alt: "Hitachi" },
  trafindo: { src: "/brands/trafindo.png", width: 440, height: 110, alt: "TRAFINDO" },
  trafoindo: { src: "/brands/trafindo.png", width: 440, height: 110, alt: "TRAFINDO" },
  ...
  legrand: { src: "/brands/legrand.png", width: 760, height: 193, alt: "Legrand" },
  socomec: { src: "/brands/socomec.png", width: 1095, height: 201, alt: "Socomec" },
  autonics: { src: "/brands/autonics.png", width: 568, height: 128, alt: "Autonics" },
  omron: { src: "/brands/omron.png", width: 1298, height: 276, alt: "Omron" },
  ...
  asenware: { src: "/brands/asenware.png", width: 1322, height: 304, alt: "ASENWARE" },
  awasenware: { src: "/brands/asenware.png", width: 1322, height: 304, alt: "ASENWARE" },
  ...
  hikvision: { src: "/brands/hikvision.png", width: 1336, height: 184, alt: "HIKVISION" },
  ...
  moxa: { src: "/brands/moxa.png", width: 571, height: 91, alt: "MOXA" },
  phoenixcontact: { src: "/brands/phoenixcontact.png", width: 975, height: 204, alt: "Phoenix Contact" },
  ...
  kabelmetalindonesia: { src: "/brands/kabelmetal.png", width: 315, height: 77, alt: "Kabelmetal Indonesia" },
  ge: { src: "/brands/ge.png", width: 500, height: 500, alt: "General Electric" },
  generalelectric: { src: "/brands/ge.png", width: 500, height: 500, alt: "General Electric" },
  danfoss: { src: "/brands/danfoss.png", width: 185, height: 72, alt: "Danfoss" },
  gae: { src: "/brands/gae.png", width: 836, height: 340, alt: "GAE" },
  lselectric: { src: "/brands/lselectric.png", width: 774, height: 258, alt: "LS Electric" },
  ls: { src: "/brands/lselectric.png", width: 774, height: 258, alt: "LS Electric" },
