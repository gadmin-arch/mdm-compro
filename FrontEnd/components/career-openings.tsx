      ...
      <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          ...
          <p className="max-w-md text-sm leading-relaxed text-muted-foreground">
            We&apos;re hiring across engineering, operations, and project management. Filter to
        ...
        <ul className="mt-8 divide-y divide-border overflow-hidden rounded-xl border border-border bg-card">
          {jobs.length === 0 ? (
            <li className="p-8 text-center text-sm text-muted-foreground">
              No open roles matched your search or filters. Check back soon or send us your CV.
            </li>
          ) : (
            jobs.map((job) => (
