  ...
  },
  {
    ...
    fields: [
      ...
      { kind: "textarea", name: "title", label: "Title" },
      {
        kind: "list",
        name: "partners",
        label: "Authorized Partners (Partner Resmi Utama)",
        itemLabel: "Partner",
        fields: [
      ...
      { kind: "lines", name: "brands", label: "Experienced Brands / Marquee (1 nama per baris - Otomatis mencocokkan logo resmi, atau format: Nama | URL)" },
      {
        kind: "list",
        name: "brandLogos",
        label: "Upload Logo Custom untuk Marquee (Jika logo belum ada di katalog bawaan)",
        itemLabel: "Brand Logo",
        fields: [
          { kind: "text", name: "name", label: "Nama Brand" },
          { kind: "image", name: "logoUrl", label: "Upload File Logo (PNG / SVG)" },
        ],
      },
    ],
    defaults: {
