...
export const DICTIONARY_EN_TO_ID: Record<string, string> = {
  ...
  "rittal enclosure systems (vx25, ax, kx)": "Sistem Enclosure Rittal (VX25, AX, KX)",
  "rittal enclosure systems": "Sistem Enclosure Rittal",
  "rittal climate control & cooling (blue e+)": "Sistem Pendingin & Climate Control Rittal (Blue e+)",
  "rittal climate control & cooling": "Sistem Pendingin & Climate Control Rittal",
  "rittal power distribution (ri4power & riline)": "Sistem Distribusi Daya Rittal (Ri4Power & RiLine)",
  "rittal power distribution": "Sistem Distribusi Daya Rittal",
  "rittal it infrastructure & data center solutions (vx it & micro dc)": "Infrastruktur IT & Solusi Data Center Rittal (VX IT & Micro DC)",
  "rittal outdoor enclosure systems (cs toptec & cs new basic)": "Sistem Enclosure Outdoor Rittal (CS Toptec & CS New Basic)",
  "rittal automation systems (perforex mt & secarex)": "Sistem Otomasi Perakitan Panel Rittal (Perforex MT & Secarex)",
  "rittal hygienic design (hd) stainless steel enclosures": "Enclosure Rittal Hygienic Design (HD) Stainless Steel",
  "rittal atex & iecex hazardous area explosion-proof enclosures": "Enclosure Rittal ATEX & IECEx Tahan Ledakan Area Berbahaya",
  "rittal hmi operator enclosures & support arm systems (cp 60/120/180)": "Enclosure Operator HMI & Sistem Lengan Penyangga Rittal (CP 60/120/180)",
  "rittal riline compact power distribution board (up to 125 a)": "Papan Distribusi Busbar Rittal RiLine Compact (hingga 125 A)",
  "rittal riline60 modular 60 mm busbar systems (up to 1600 a)": "Sistem Busbar Modular 60 mm Rittal RiLine60 (hingga 1600 A)",
  "rittal maxi-pls & flat-pls high-current busbar systems (up to 6300 a)": "Sistem Busbar Arus Tinggi Rittal Maxi-PLS & Flat-PLS (hingga 6300 A)",
  "rittal toptherm fan-and-filter units & roof-mounted ventilation": "Unit Fan-Filter TopTherm & Ventilasi Atap Panel Rittal",
  "rittal air-to-water heat exchangers & industrial blue e+ chillers": "Penukar Panas Udara-ke-Air & Chiller Industri Rittal Blue e+",
  "rittal enclosure heaters, thermostats & hygrostats (anti-condensation)": "Pemanas Panel, Termostat & Higrostat Rittal (Anti-Kondensasi)",
  "rittal perforex lc 3d laser machining centers (enclosure modification)": "Mesin Modifikasi Laser 3D Rittal Perforex LC (Panel & Kubikal)",
  "rittal wire terminal wt fully automated wire processing & harnessing system": "Mesin Pemroses & Pengkabelan Otomatis Rittal Wire Terminal WT",
  "rittal copper workstation cw 120 (busbar bending, punching & cutting)": "Meja Kerja Pemrosesan Busbar Tembaga Rittal Copper Workstation CW 120",
  "rittal tx cablenet network racks (waterfall cable management)": "Rak Jaringan & Server Rittal TX CableNet (Manajemen Kabel Waterfall)",
  "rittal intelligent it pdu (metered, switched & managed power distribution)": "Unit Distribusi Daya Cerdas Rittal IT PDU (Metered, Switched & Managed)",
  "rittal liquid cooling packages (lcp cw & dx high-density it cooling)": "Unit Pendingin Cair Rittal Liquid Cooling Package (LCP CW & DX High-Density)",
  "rittal led system lights (sz 2500 enclosure illumination)": "Lampu Panel LED Rittal System Light (Penerangan Kabinet Seri SZ 2500)",
  "rittal base/plinth system vx (modular enclosure foundation)": "Sistem Plinth / Pondasi Modular Rittal Base/Plinth System VX",
  "rittal modular cable entry systems & gland plates (ip66 ingress protection)": "Sistem Masukan Kabel Modular & Pelat Gland Rittal (Proteksi IP66)",
  "schneider industrial automation (modicon & ecostruxure)": "Otomasi Industri Schneider (Modicon & EcoStruxure)",
  "power & energy monitoring (pme & powerlogic)": "Pemantauan Daya & Energi (PME & PowerLogic)",
  "electrical distribution integration (masterpact & prisma)": "Integrasi Distribusi Elektrikal (MasterPact & Prisma)",
  "schneider engineering, fat/sat & commissioning support": "Rekayasa Schneider, Dukungan FAT/SAT & Komisioning",
  "medium voltage substation & transformers": "Gardu Induk Tegangan Menengah & Transformator",
  "low voltage panels (mdp, sdp, ats & sync)": "Panel Tegangan Rendah (MDP, SDP, ATS & Sinkronisasi)",
  "scada systems & process monitoring (xarrow)": "Sistem SCADA & Pemantauan Proses (xArrow)",
  "variable speed drive (vsd) & inverter panels": "Panel Variable Speed Drive (VSD) & Inverter",
  "active harmonic filters (ahf) & svg": "Filter Harmonisa Aktif (AHF) & SVG",
